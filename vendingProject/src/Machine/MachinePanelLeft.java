...
public class MachinePanelLeft extends JPanel {
	...
	public MachinePanelLeft() {
		...
		moneyPanel.setBackground(new Color(190, 110, 120));
		takeMoneyPanel.setBackground(new Color(190, 110, 120));
		putMoneyPanel.setBackground(new Color(190, 110, 120));
		getCanPanel.setBackground(new Color(190, 110, 120));
		setBackground(new Color(190, 110, 120));
